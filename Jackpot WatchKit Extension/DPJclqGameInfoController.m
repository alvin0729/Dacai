...
#import "DPJclqGameInfoController.h"
#import "DPWatchShareDataDefine.h"
#import <MMWormhole/MMWormhole.h>
#import "GameLivingARowController.h"
@interface DPJclqGameInfoController ()

@property (nonatomic, strong) MMWormhole *wormhole;
@property(nonatomic,assign)NSInteger rowIndex;
@end

@implementation DPJclqGameInfoController
...
- (void)willActivate {
    ...
    if (homeImage) {
        ...
        [self.rightImage setImage:homeImage];
    ...
    if (awayImage) {
        ...
        [self.leftImage setImage:awayImage];
    }else{
