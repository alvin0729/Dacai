...
@interface SfcResultController : WKInterfaceController
...
@property(nonatomic,weak)IBOutlet WKInterfaceLabel *drawLabel8;
@property(nonatomic,weak)IBOutlet WKInterfaceLabel *drawLabel9;
@property(nonatomic,weak)IBOutlet WKInterfaceLabel *drawLabel10;
@property(nonatomic,weak)IBOutlet WKInterfaceLabel *drawLabel11;
@property(nonatomic,weak)IBOutlet WKInterfaceLabel *drawLabel12;
@property(nonatomic,weak)IBOutlet WKInterfaceLabel *drawLabel13;
@property(nonatomic,weak)IBOutlet WKInterfaceLabel *drawLabel14;
