...
#import "KTMFileHelper.h"

@interface KTMFileHelper () {
@private
...
@implementation KTMFileHelper

+ (instancetype)sharedInstance {
    static KTMFileHelper *sharedInstance;
...
+ (BOOL)remove:(NSString *)file {
    return [[self sharedInstance] remove:file];
}
