...
@implementation UIColor (KTMAdditions)
...
+ (UIColor *)dp_flatBackgroundColor {
    return [UIColor colorWithRed:0.98 green:0.98 blue:0.95 alpha:1];
}
...
+ (UIColor *)dp_flatRedColor {
    return [UIColor colorWithRed:0.87 green:0.31 blue:0.29 alpha:1];
}
...
+ (UIColor *)dp_flatBlueColor {
     return [UIColor colorWithRed:0.22 green:0.47 blue:0.86 alpha:1];
}
