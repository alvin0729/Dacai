...
#import "UIWebView+KTMAdditions.h"

@implementation UIWebView (KTMAdditions)
...
- (void)dp_fitWidth {
    [self stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"document.querySelector('meta[name=viewport]').setAttribute('content', 'width=%d;', false); ", (int)CGRectGetWidth(self.bounds)]];
}
