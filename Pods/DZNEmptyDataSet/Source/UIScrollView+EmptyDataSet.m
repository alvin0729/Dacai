...
//        [self addConstraint:[NSLayoutConstraint constraintWithItem:self.contentView attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeBottom multiplier:1 constant:0]];
        ...
        NSLayoutConstraint *centerXConstraint = [self.contentView equallyRelatedConstraintWithView:_customView attribute:NSLayoutAttributeCenterX];
        NSLayoutConstraint *centerYConstraint = [self.contentView equallyRelatedConstraintWithView:_customView attribute:NSLayoutAttributeCenterY];
