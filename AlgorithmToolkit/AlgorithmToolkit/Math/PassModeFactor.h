...
public:
    static CPassModeFactor *SharedInstance() {
        static CPassModeFactor *instance = NULL;
        if (instance == NULL) {
            instance = new CPassModeFactor();
        }
        return instance;
    }
    ...
    int GetFreedomPassModes(int *gameTypes, int typeCount, int markCount, int matchCount, vector<int> &freedomTags);
    int GetCombinePassModes(int *gameTypes, int typeCount, int markCount, int matchCount, vector<int> &combineTags);
