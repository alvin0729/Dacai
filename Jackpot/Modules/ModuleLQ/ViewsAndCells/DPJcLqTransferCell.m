...
- (void)loadRfDragView {
    ...
    [leftButton setBackgroundImage:[dp_SportLotteryImage(@"transferLeftNormal.png") resizableImageWithCapInsets:UIEdgeInsetsMake(0, 15, 0, 0) resizingMode:UIImageResizingModeStretch] forState:UIControlStateNormal];
    [leftButton setBackgroundImage:[dp_SportLotteryImage(@"transferLeftSel.png") resizableImageWithCapInsets:UIEdgeInsetsMake(0, 15, 0, 0) resizingMode:UIImageResizingModeStretch] forState:UIControlStateSelected];
    ...
    [rightButton setBackgroundImage:[dp_SportLotteryImage(@"transferRightNormal.png") resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 15) resizingMode:UIImageResizingModeStretch] forState:UIControlStateNormal];
    [rightButton setBackgroundImage:[dp_SportLotteryImage(@"transferRightSel.png") resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 15) resizingMode:UIImageResizingModeStretch] forState:UIControlStateSelected];
...
- (void)buttonSelected:(UIButton *)button {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(jclqTranCell:selectedIndex:isSelected:)]) {
        [self.delegate jclqTranCell:self selectedIndex:(int)button.tag - 2000 isSelected:button.selected];
    }
}
#pragma mark - private
