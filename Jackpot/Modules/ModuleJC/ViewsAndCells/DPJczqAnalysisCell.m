...
- (void)buildLayout {
    ...
    [goAnalysisButton setImage:dp_SportLotteryImage(@"jczqMatch.png") forState:UIControlStateNormal];
...
- (UILabel *)rqWinLabel
{
    ...
    _rqWinLabel.textColor =[UIColor colorWithRed:0.89 green:0.9 blue:0.89 alpha:1];
