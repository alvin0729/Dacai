...
- (void)layoutSubviews {
    ...
    if ((self.orientation == UIInterfaceOrientationLandscapeLeft || self.orientation == UIInterfaceOrientationLandscapeRight) && self.supportRotate) {
        ...
        self.titleSegment.textColor = UIColorFromRGB(0x7e6b5a) ;

        self.titleSegment.tintColor = UIColorFromRGB(0x665445) ;
        ...
        self.titleSegment.textColor = UIColorFromRGB(0xffa2a2) ;

        self.titleSegment.tintColor = UIColorFromRGB(0xb81c1b) ;
...
- (UIView *)switchView {
    if (_switchView == nil) {
        ...
        _switchView.backgroundColor = [UIColor dp_flatRedColor];
...
-(UIButton*)introduceBtn{
    ...
    if (_introduceBtn == nil) {
        ...
        [_introduceBtn setTitleColor:[UIColor dp_flatWhiteColor] forState:UIControlStateNormal];
        [_introduceBtn setTitle:@"帮助" forState:UIControlStateNormal];
...
//        [_introduceBtn setImage:dp_NavigationImage(@"introduceImg.png") forState:UIControlStateNormal];
        ...
        _introduceBtn.titleLabel.font = [UIFont dp_systemFontOfSize:16];
    }
...
- (void)viewDidLoad {
    ...
    if (self.supportRation) { //支持旋转的时候才加
        ...
        if([self dp_isOrientationLandscape]){
            ...
            [ _backBtn setImage:[dp_NavigationImage(@"back.png") dp_imageWithTintColor: UIColorFromRGB(0x665445)] forState:UIControlStateNormal];
            [_introduceBtn setTitleColor:[UIColor dp_flatRedColor]  forState:UIControlStateNormal];
...
- (void)willRotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration {
    ...
    if(toInterfaceOrientation == UIInterfaceOrientationLandscapeLeft || toInterfaceOrientation == UIInterfaceOrientationLandscapeRight){
        ...
        self.headerView.switchView.backgroundColor = [UIColor dp_flatRedColor] ;
