...
@property (nonatomic, strong, readonly)UIImageView  *leftLine;
...
- (void)setIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath) {
        ...
        _leftLine.image = [UIImage dp_imageWithColor:[self getColorWithIndexPath:indexPath]];
        _leftLine.highlightedImage = [UIImage dp_imageWithColor:[self getColorWithIndexPath:indexPath]];
    }
