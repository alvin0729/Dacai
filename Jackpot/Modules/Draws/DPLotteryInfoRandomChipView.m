...
- (void)buildUI
{
    ...
    UIColor *color6 = [UIColor dp_flatRedColor];
    if (self.viewType == KRandomChipViewTypeDlt) {
        color6 = [UIColor blueColor];
    }
    UILabel *label1 = [self createLabelBallWithTitle:@"06" color:[UIColor dp_flatRedColor]];
    UILabel *label2 = [self createLabelBallWithTitle:@"09" color:[UIColor dp_flatRedColor]];
    UILabel *label3 = [self createLabelBallWithTitle:@"19" color:[UIColor dp_flatRedColor]];
    UILabel *label4 = [self createLabelBallWithTitle:@"09" color:[UIColor dp_flatRedColor]];
    UILabel *label5 = [self createLabelBallWithTitle:@"02" color:[UIColor dp_flatRedColor]];
