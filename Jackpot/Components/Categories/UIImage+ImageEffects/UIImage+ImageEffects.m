...
- (UIImage *)dp_applyLightEffect
{
    ...
    return [self dp_applyBlurWithRadius:30 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)dp_applyExtraLightEffect
{
    ...
    return [self dp_applyBlurWithRadius:20 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)dp_applyTintEffectWithColor:(UIColor *)tintColor
{
    ...
    return [self dp_applyBlurWithRadius:10 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
