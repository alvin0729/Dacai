...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.didSelectedIndex = ^(NSInteger index){
        ...
        UMComUMengLoginHandler *loginHandler = [[UMComUMengLoginHandler alloc]init];
        [loginHandler didSelectPlatform:platformName feed:weakSelf.feed viewController:weakSelf.shareViewController];
        [weakSelf dismiss];
